...
tiff("path_diagram_AB_Sci.tiff", width = 85,  height = 120, units = "mm", res = 300,bg = "transparent")
...
tiff("path_diagram_GB_Sci.tiff", width = 85,  height = 120, units = "mm", res = 300,bg = "transparent")
...
tiff("path_diagram_AB_Pred.tiff", width = 85,  height = 120, units = "mm", res = 300,bg = "transparent")
...
tiff("path_diagram_GB_Pred.tiff",width = 85,  height = 120, units = "mm", res = 300,bg = "transparent")
